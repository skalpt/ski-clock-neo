...
*   **MQTT Integration:** Publishes device heartbeats and display snapshots to HiveMQ Cloud. Supports TLS encryption. Subscribes to device-specific topics for remote `rollback`, `restart`, `snapshot`, and `config` commands.
